...
const ui = {
  ...
  inventory: document.querySelector('#inventory'), towerCategories: document.querySelector('#towerCategories'), upgradePanel: document.querySelector('#upgradePanel'), resetViewButton: document.querySelector('#resetViewButton'), mapButton: document.querySelector('#mapButton'), mapPanel: document.querySelector('#mapPanel'), saveButton: document.querySelector('#saveButton'), indexButton: document.querySelector('#indexButton'), indexPanel: document.querySelector('#indexPanel'), statsButton: document.querySelector('#statsButton'), statsPanel: document.querySelector('#statsPanel'), gemButton: document.querySelector('#gemButton'), gemPanel: document.querySelector('#gemPanel'), guideButton: document.querySelector('#guideButton'), guidePanel: document.querySelector('#guidePanel'), drawCost: document.querySelector('#drawCost') || document.querySelector('#rollButton small'), rouletteLevel: document.querySelector('#rouletteLevel'), modal: document.querySelector('#modal'), modalTitle: document.querySelector('#modalTitle'), modalText: document.querySelector('#modalText'), baseUpgradeChoices: document.querySelector('#baseUpgradeChoices'), startButton: document.querySelector('#startButton')
};
